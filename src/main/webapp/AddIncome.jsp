...
<div  class="bg-gray-100 w-screen h-screen flex justify-center">
<div class=" w-1/3 max-w-m  h-full flex items-center ">
  <form class="w-full bg-white shadow-md rounded px-8  pt-6 pb-8 mb-4" action="AddIncomeLink" method="post">
    ...
    <h1 class="mb-4 block text-gray-700 text-xl font-bold mb-2" >ADD INCOME</h1>
    </div>
    ...
    <div class="mb-4">
      ...
      <input  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" name="income" type="text" placeholder="5000" pattern="[0-9]*" required>
    </div>
     <div class="w-full  md:w-full  mb-6 md:mb-0">
      ...
      <div class="relative">
        <select name="category" class="mb-4 block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
          ...
          <option  name="category" value="investmentincome">InvestmentIncome</option>
          <option  name="category" value="pension">Pension</option>
    ...
    <div class="mb-4">
      ...
      <input  class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="addNote" type="text" name="note">
    </div>
    <div class="mb-4">
